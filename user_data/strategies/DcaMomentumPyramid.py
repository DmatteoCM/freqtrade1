...
class DcaMomentumPyramid(IStrategy):
    """
    DCA Momentum Pyramid Strategy
    - Stessa logica di DcaMomentum ma con stake crescente per ogni tranche
    - stake_n = tranche_usd * (tranche_multiplier ^ nr_of_successful_entries)
    - Tranche 1: 6 USDC, T2: 7.8, T3: 10.14, ... T10: ~63.6 (totale max ~255 USDC)
    """
    ...
    def custom_exit(
        ...
        **kwargs,
        ...
        # Prezzo deve essere sopra il costo medio
    ...
    def adjust_trade_position(
        ...
        **kwargs,
        ...
        stake = min(self.tranche_usd * (self.tranche_multiplier ** nr), max_stake)
