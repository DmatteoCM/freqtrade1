...
class ema_scalping(IStrategy):
    ...
    # Trailing stop — activated and optimized via hyperopt
    trailing_stop = True
    trailing_stop_positive = 0.01
    trailing_stop_positive_offset = 0.02
    trailing_only_offset_is_reached = True

    # Base stoploss — hyperopt will refine via trailing
    stoploss = -0.05
    ...
    volume_multiplier = DecimalParameter(low=0.8, high=2.0, default=1.0, decimals=1, space="buy", optimize=True, load=True)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Apply trailing stop hyperopt params at runtime
