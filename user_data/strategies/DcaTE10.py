...
class DcaTE10(IStrategy):
    """
    DcaTE10 — variante di DcaMomentum con uscita temporale forzata a 10 giorni
    - Stessa logica di ingresso di DcaMomentum (Momentum + Accumulo)
    - Uscita normale: min_tranches + profitto > 0 + BB superiore 1h + RSI 1h
    - Uscita forzata: dopo 10 giorni, chiude SEMPRE anche in perdita
    """
